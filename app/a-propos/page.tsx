  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-16 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-semibold text-foreground mb-4">Notre mission</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="text-center hover:shadow-lg transition-all duration-300">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-semibold text-foreground mb-4">Rassembler</h3>
            ...
            <Card className="text-center hover:shadow-lg transition-all duration-300">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-semibold text-foreground mb-4">Éclairer</h3>
                <p className="text-muted-foreground leading-relaxed">
            ...
            <Card className="text-center hover:shadow-lg transition-all duration-300">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-semibold text-foreground mb-4">Inspirer</h3>
                <p className="text-muted-foreground leading-relaxed">
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div>
                <h2 className="text-3xl md:text-4xl font-semibold text-foreground mb-6">Nos valeurs</h2>
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">Indépendance éditoriale</h3>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">Diversité des voix</h3>
                    <p className="text-muted-foreground">
                ...
                <div className="flex gap-4">
                  <div className="w-2 h-2 bg-primary rounded-full mt-3 flex-shrink-0" />
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">Constructivité</h3>
                    <p className="text-muted-foreground">
            ...
            <div className="relative">
              <div className="aspect-square bg-gradient-to-br from-primary/10 via-secondary/10 to-accent/10 rounded-2xl p-8 flex items-center justify-center">
                <div className="text-center space-y-4">
                  ...
                  <h3 className="text-2xl font-semibold text-foreground">Ensemble</h3>
                  <p className="text-muted-foreground">
      ...
      <section className="py-16 bg-muted/30">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-semibold text-foreground mb-4">Notre équipe</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="text-center hover:shadow-lg transition-all duration-300">
              <CardContent className="p-6">
                ...
                <h3 className="font-semibold text-foreground mb-2">Marie Rousseau</h3>
            ...
            <Card className="text-center hover:shadow-lg transition-all duration-300">
              <CardContent className="p-6">
                ...
                <h3 className="font-semibold text-foreground mb-2">Antoine Dubois</h3>
            ...
            <Card className="text-center hover:shadow-lg transition-all duration-300">
              <CardContent className="p-6">
                ...
                <h3 className="font-semibold text-foreground mb-2">Clara Lefebvre</h3>
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-semibold text-foreground mb-4">Notre histoire</h2>
              ...
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-foreground mb-2">Naissance du projet</h3>
                    <p className="text-muted-foreground leading-relaxed">
            ...
            <Card className="border-l-4 border-l-secondary">
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-foreground mb-2">Développement de la communauté</h3>
                    <p className="text-muted-foreground leading-relaxed">
            ...
            <Card className="border-l-4 border-l-accent">
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-foreground mb-2">Expansion et nouveaux projets</h3>
                    <p className="text-muted-foreground leading-relaxed">
      ...
      <section className="py-16 bg-muted/30">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="space-y-8">
            <div>
              <h2 className="text-3xl md:text-4xl font-semibold text-foreground mb-4">Rejoignez-nous</h2>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
