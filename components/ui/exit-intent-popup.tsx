  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent className="sm:max-w-md border-none overflow-hidden p-0">
        <div className="bg-white p-6 text-primary-foreground">
          <div className="mx-auto flex items-center justify-center rounded-full">
            <Image alt="Logo EGC" src="/images/logo-egc.png" width={200} height={104} fetchPriority="high"/>
          </div>
        </div>
        <div className="p-6 pt-4">
          <DialogHeader className="space-y-3 mb-6">
            <DialogTitle className="text-center text-2xl uppercase font-extrabold">
              {title}
            </DialogTitle>
          ...
          {submitStatus === "success" ? (
            <div className="space-y-4">
              <div className="flex items-center gap-3 p-4 bg-green-50 border-2 border-emerald-600 rounded-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2 pt-2">
                <Button
                  type="submit"
                  className="w-full gap-2 bg-green-600 hover:bg-green-600/90 text-white"
                  size="lg"
