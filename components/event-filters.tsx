    ...
    <div className="space-y-4">
      ...
      <div className="relative">
        ...
        <Input
          ...
          className="pl-10 border border-[#E73628] focus-visible:ring-[#E73628]"
        />
      </div>
      ...
      <div className="flex flex-wrap gap-4">
        ...
        {hasActiveFilters && (
          <Button
            ...
            className="flex items-center gap-2 bg-transparent border border-[#E73628] text-[#E73628] hover:bg-[#E73628] hover:text-white"
          >
            <X className="h-4 w-4" />
            Effacer
          </Button>
        ...
        <div className="flex flex-wrap gap-2">
          ...
          {selectedType !== "all" && (
            <Badge className="flex items-center gap-1 bg-[#F4E63C] text-black hover:bg-[#F4E63C]/90">
              Type:{" "}
              {eventTypes.find((t) => t.slug === selectedType)?.name ||
                selectedType}
              <X
                className="h-3 w-3 cursor-pointer"
